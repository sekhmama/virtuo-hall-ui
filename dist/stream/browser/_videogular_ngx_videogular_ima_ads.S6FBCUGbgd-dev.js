// node_modules/@videogular/ngx-videogular/fesm2022/videogular-ngx-videogular-ima-ads.mjs
...
var VgImaAdsComponent = class _VgImaAdsComponent {
  ...
  static {
    this.ɵfac = function VgImaAdsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _VgImaAdsComponent)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i1.VgApiService), i0.ɵɵdirectiveInject(i1.VgFullscreenApiService));
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */i0.ɵɵdefineComponent({
      type: _VgImaAdsComponent,
      selectors: [["vg-ima-ads"]],
      hostVars: 2,
      hostBindings: function VgImaAdsComponent_HostBindings(rf, ctx) {
        if (rf & 2) {
      ...
      inputs: {
        ...
        vgSkipButtonLocale: "vgSkipButtonLocale"
      },
      outputs: {
        onAdStart: "onAdStart",
        onAdStop: "onAdStop",
      ...
      vars: 0,
      consts: [[1, "vg-ima-ads"]],
      template: function VgImaAdsComponent_Template(rf, ctx) {
        if (rf & 1) {
...
var VgImaAdsModule = class _VgImaAdsModule {
  static {
    this.ɵfac = function VgImaAdsModule_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _VgImaAdsModule)();
    };
  }
  static {
    this.ɵmod = /* @__PURE__ */i0.ɵɵdefineNgModule({
      type: _VgImaAdsModule
    });
  }
  static {
